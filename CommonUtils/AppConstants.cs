...
namespace ProjectCleaner.CommonUtils
{
    public static class AppConstants
    {
        ...
        public const string OUTPUT_DIRECTORY = "PC_";

        public const string ANOTHER_INSTANCE_RUNNING = "Another instance of projet cleaner is already running";

        public const string LOGFILENAME = "PC_ErrorLog.txt";
